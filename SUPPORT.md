...
- whether the behavior affects compatibility, mapping loss, provenance, or authority semantics.
...
MeaningWire currently has no official commercial support provider. Any future commercial ecosystem must be clearly distinguished from the open-source project's governance and must not receive hidden technical authority.
